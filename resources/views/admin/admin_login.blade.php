              ...
              <div class="col-lg-6 bg-white">
                ...
                <div class="d-flex align-items-center px-4 px-lg-5 h-100">
                  <form class="login-form py-5 w-100" method="post" action="{{ route('login') }}">
                    ...
                    <button class="btn btn-primary mb-3"type="submit">Login</button><br><a class="text-sm text-paleBlue" href="#">Forgot Password?</a><br><small class="text-gray-500">Do not have an account? </small><a class="text-sm text-paleBlue" href="{{ route('register') }}">Signup</a>
                  </form>
                </div>
              </div>
            </div>
